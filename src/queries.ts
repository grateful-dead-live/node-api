...
const SONGMAP: SongMap = JSON.parse(fs.readFileSync('data/json/app_song_map.json', 'utf8'));
...
//const VENUEDETAILS = JSON.parse(fs.readFileSync('data/json/venue_details_list.json', 'utf8'));
